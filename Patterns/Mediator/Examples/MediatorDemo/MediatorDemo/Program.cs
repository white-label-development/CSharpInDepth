...
namespace MediatorDemo
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine();
            steve.SendTo<Developer>("Make sure to execute your unit tests before checking in!"); // SendTo<T>
        }


        // worth a reminder: https://stackoverflow.com/questions/9226479/mediator-vs-observer-object-oriented-design-patterns
